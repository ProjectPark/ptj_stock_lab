...
전략 리뷰 문서 → PDF 변환
===========================
docs/notes/taejun_strategy_review_2026-02-21_SK.md → docs/pdf/taejun_strategy_review_2026-02-21_SK.pdf
"""
...
MD_PATH = ROOT / "docs" / "notes" / "taejun_strategy_review_2026-02-21_SK.md"
PDF_DIR = ROOT / "docs" / "pdf"
PDF_PATH = PDF_DIR / "taejun_strategy_review_2026-02-21_SK.pdf"
...
class StrategyPDF(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 6, "taejun_attach_pattern — 전략 리뷰 2026-02-21 (SK)", align="R")
        self.ln(8)
