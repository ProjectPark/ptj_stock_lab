...
MD_PATH = ROOT / "docs" / "notes" / "line_b" / "review" / "taejun_strategy_review_2026-02-26_VNQ.md"
PDF_DIR = ROOT / "docs" / "pdf"
PDF_PATH = PDF_DIR / "taejun_strategy_review_2026-02-26_VNQ.pdf"
...
class StrategyPDF(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 6, "taejun_attach_pattern — 전략 리뷰 2026-02-26 (VNQ)", align="R")
        self.ln(8)
